...
export const metadata: Metadata = {
  ...
  description: "阿甘资本 外汇交易员训练营培训体系：规则练习(3天)、盈利练习(20天)、小额实盘(20天)、大额矩阵。严格的考核标准，完善的风控要求，系统化的职业外汇交易员培养流程。通过率<18%。",
  keywords: ["外汇交易员培训", "交易培训体系", "交易规则学习", "盈利考核", "实盘训练", "风控管理", "交易纪律", "阿甘资本"],
  openGraph: {
    title: "培训体系 - 30天外汇交易员训练营",
