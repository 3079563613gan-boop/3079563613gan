...
export const tradingPsychologyContent = {
  zh: {
    title: '交易心理学 - 克服恐惧贪婪FOMO，建立交易纪律与情绪管理体系 | 阿甘资本',
    ...
    ctaTitle: '想要系统提升交易心理？',
    ctaDescription: '加入 阿甘资本 交易心理培训，获取专业心理评估和一对一心理辅导',
  ...
  en: {
    title: 'Trading Psychology - Overcome Fear Greed FOMO, Build Discipline & Emotional Management | 阿甘资本',
    ...
    ctaDescription: 'Join 阿甘资本 trading psychology training for professional psychological assessment and one-on-one counseling',
