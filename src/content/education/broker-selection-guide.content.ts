...
export const brokerSelectionContent = {
  zh: {
    title: '外汇经纪商选择完整指南 - 如何识别安全可靠的外汇平台 | 阿甘资本',
    ...
    ctaTitle: '寻找可靠的外汇经纪商？',
    ctaDescription: '阿甘资本只推荐受严格监管、信誉良好的合作经纪商',
  ...
  en: {
    title: 'Complete Forex Broker Selection Guide - How to Identify Safe and Reliable Platforms | 阿甘资本',
    ...
    relatedResources: [
      ...
      },
      {
        href: '/partners/brokers',
        icon: '🤝',
        title: '阿甘资本 Partner Brokers',
        description: 'View our recommended regulated brokers'
      }
    ],

    ctaTitle: 'Looking for Reliable Forex Brokers?',
    ctaDescription: '阿甘资本 only recommends strictly regulated, reputable partner brokers',
