...
export const stopLossStrategiesContent = {
  zh: {
    title: '止损策略大全 - 固定止损、ATR止损、技术止损与追踪止损完整指南 | 阿甘资本',
    ...
    ctaTitle: '想要优化你的止损策略？',
    ctaDescription: '使用 阿甘资本 专业止损工具，实现自动化止损管理',
  ...
  en: {
    title: 'Complete Stop Loss Strategies - Fixed, ATR, Technical & Trailing Stops Guide | 阿甘资本',
    ...
    ctaDescription: 'Use 阿甘资本 professional stop-loss tools for automated stop management',
