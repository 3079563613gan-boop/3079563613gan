...
export const supportResistanceContent = {
  zh: {
    title: '支撑阻力与趋势线完整指南 - 水平位、动态位与突破交易策略 | 阿甘资本',
    ...
    ctaTitle: '想要精通支撑阻力交易？',
    ctaDescription: '加入阿甘资本培训，学习专业支撑阻力识别与突破交易策略',
  ...
  en: {
    title: 'Support Resistance & Trendlines Guide - Horizontal, Dynamic Levels & Breakout Strategies | 阿甘资本',
    ...
    ctaDescription: 'Join 阿甘资本 training to learn professional S/R identification and breakout strategies',
