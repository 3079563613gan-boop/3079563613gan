...
export const leverageMarginContent = {
  zh: {
    title: '外汇杠杆与保证金完整指南 - 深度解析交易杠杆原理与风险 | 阿甘资本',
    ...
    ctaDescription: '加入 阿甘资本 培训，掌握职业交易员的风险控制技巧',
  ...
  en: {
    title: 'Complete Guide to Forex Leverage and Margin - Deep Dive into Trading Mechanisms | 阿甘资本',
    ...
    ctaDescription: 'Join 阿甘资本 training to learn professional risk control techniques',
