...
export const scalpingContent = {
  zh: {
    title: '剥头皮交易完整指南 - Scalping超短线策略与快速执行技巧 | 阿甘资本',
    ...
    ctaTitle: '想要学习专业交易策略？',
    ctaDescription: '加入 阿甘资本 培训计划，从基础策略开始系统学习',
  ...
  en: {
    title: 'Complete Scalping Guide - Ultra-Short-Term Strategies and Fast Execution | 阿甘资本',
    ...
    ctaDescription: 'Join 阿甘资本 training to systematically learn from foundational strategies',
