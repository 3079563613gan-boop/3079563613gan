...
export const forexBasicsContent = {
  zh: {
    title: '外汇交易基础知识完整指南 - 从零开始学习外汇交易 | 阿甘资本',
    ...
    ctaDescription: '加入 阿甘资本 30天系统化培训，从零基础到职业交易员',
  ...
  en: {
    title: 'Complete Guide to Forex Trading Basics - Learn Forex from Scratch | 阿甘资本',
    ...
    ctaDescription: 'Join 阿甘资本 30-day systematic training, from beginner to professional trader',
