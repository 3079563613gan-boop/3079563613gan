...
export const blogPosts: BlogPost[] = [
 ...
 title: {
 zh: '关于汇刃 (阿甘资本) - 军事化外汇交易员训练营',
 en: 'About 阿甘资本 - Military-Style Forex Trader Training Camp'
 },
 excerpt: {
 zh: '汇刃 (阿甘资本) 是一个专注于筛选和培养外汇交易员的训练营。我们的理念：培养真正适合的人，留下极少数，劝返大多数。通过率10%-15%，30个工作日完整培训，盈利分成60%-90%。',
 en: '阿甘资本 is a training camp focused on selecting and cultivating forex traders. Our philosophy: cultivating those truly suited, retaining the few, advising the majority. Pass rate 10%-15%, 30 working days complete training, 60%-90% profit share.'
 },
 content: {
 zh: `<h1 class="text-4xl font-bold text-center mb-8 text-black dark:text-white">关于汇刃 (阿甘资本)</h1>
...
<p class="text-sm text-gray-500 dark:text-gray-500">邮箱：3079563613gan@gmail.com</p>
</div>
</div>
</div>
...
<li class="text-white dark:text-black leading-relaxed flex items-start gap-2"><span class="font-bold">•</span><span>如有虚假信息，一经发现立即淘汰</span></li>
 ...
 en: `<h1 class="text-4xl font-bold text-center mb-8 text-black dark:text-white">About 阿甘资本 (阿甘资本)</h1>

<p class="text-base leading-relaxed mb-8 text-center text-gray-700 dark:text-gray-300">阿甘资本 is a military-style training camp focused on selecting and cultivating top forex traders. We don't pursue quantity, only cultivating those truly suited. This is a strict, high-intensity, high-elimination professional training program.</p>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">阿甘资本 adopts a military-style management model because we know: trading is a psychological war requiring extreme discipline, execution, and mental strength. Our training isn't about teaching you how to get rich quick, but cultivating you to become a professional, sustainable trader.</p>
...
<p class="text-sm text-gray-500 dark:text-gray-500">Email: 3079563613gan@gmail.com</p>
</div>
</div>
</div>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">阿甘资本 is not just a training institution, but more like a highly disciplined military camp. We won't promise you quick riches or easy success. What we can provide is:</p>
...
<p class="text-lg text-center text-white dark:text-black">Email us: 3079563613gan@gmail.com</p>
</div>
...
<div class="bg-black dark:bg-white text-white dark:text-black p-8 mb-8 border-2 border-black dark:border-white">
<p class="text-2xl font-bold mb-4 text-white dark:text-black text-center">阿甘资本 Recommendation: Swing Trading Strategy</p>
...
<p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">Real trading record from an 阿甘资本 student (anonymized)</p>
<div class="overflow-x-auto">
<table class="w-full border-2 border-gray-300 dark:border-gray-700">
<thead>
<tr class="bg-gray-200 dark:bg-gray-800">
